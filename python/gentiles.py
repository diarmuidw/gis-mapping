...
if __name__ == "__main__":
    ...
    maxZoom = 10
    bbox = (-10, 51.0,-7,53)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, 'kerry')

    maxZoom = 15
    bbox = (-10.03, 51.9,-9.7,52.137)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, 'kerry')

    maxZoom = 17
    bbox = (-9.85, 51.99,-9.79,52.03)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, 'smallkerry')
'''
    minZoom = 4
    maxZoom = 14
    bbox = (-10.03, 51.95,-9.7,52.137)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, 'kerry')
    ...
    render_tiles(bbox, mapfile, tile_dir, 0, 20, "kerry")
    # Muenchen
